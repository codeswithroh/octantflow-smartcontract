...
import {MorphoYieldDonatingSetup as Setup, IStrategyInterface, ITokenizedStrategy, ERC20} from "./MorphoYieldDonatingSetup.sol";
...
contract MorphoYieldDonatingOperationTest is Setup {
    ...
    function test_setupStrategyOK() public {
        if (!configOk) return;
        console2.log("address of morpho strategy", address(strategy));
